...
**[Optimal Convex Hulls for Low-Rank Data in High-Dimensional Space](https://winstondodson.github.io/CT-QuickHull/)**
...
```bash
git clone https://github.com/winstondodson/CT-QuickHull.git
cd CT-QuickHull
