...
**[Optimal Convex Hulls for Low-Rank Data in High-Dimensional Space](https://YourGitHubUsername.github.io/CT-QuickHull/)**

## Citation

Dodson, W. (2026). *CT-QuickHull: Causal Sparsity on Ancestry DAGs for 
Exact Convex Hull Construction* (v1.5.1). Zenodo.  
**DOI:** [10.5281/zenodo.20100509](https://doi.org/10.5281/zenodo.20100509)
...
```bash
git clone https://github.com/YourGitHubUsername/CT-QuickHull.git
cd CT-QuickHull
jupyter notebook code/ct_quickhull_experiments.ipynb
```

Or open the notebook directly in [Google Colab](https://colab.research.google.com/) 
...
ORCID: [0009-0001-7148-0764](https://orcid.org/0009-0001-7148-0764)  
